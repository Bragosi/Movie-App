...
const HorizontalScrollCard = ({ data = [], heading, trending }) => {
  ...
  return (
    <div className="container mx-auto px-3 my-10">
      <h2 className="text-xl font-bold mb-2 lg:text-2xl text-white capitalize">
        {heading}
      </h2>
      <div className="relative">
        <div
          ref={containerRef}
          className="scroll-smooth transition-all grid grid-cols-[repeat(auto-fit,_minmax(230px,_1fr))] gap-6 grid-flow-col overflow-x-scroll noScrollBar"
        >
          {data.map((data, index) => {
            return (
              <Card
